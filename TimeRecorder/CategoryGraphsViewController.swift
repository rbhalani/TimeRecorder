//
//  CategoryGraphsViewController.swift
//  TimeRecorder
//
...
class CategoryGraphsViewController: UIPageViewController {
    ...
    private(set) lazy var orderedGraphs: [UIViewController] = {
        return [self.newGraph("CategoryGraphContentViewController"), self.newGraph("CategoryGraphContentViewController2")]
    }()
...
extension CategoryGraphsViewController: UIPageViewControllerDataSource {
