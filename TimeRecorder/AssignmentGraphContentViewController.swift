//
//  AssignmentGraphContentViewController.swift
//  TimeRecorder
//
...
class AssignmentGraphContentViewController: BarChartViewController {
    ...
    override func viewDidLoad() {
        ...
        let selectedCategory = self.dataStack.category!
        ...
        let timeRecordsInCategory = fetchEntitiesInObject("TimeRecord", predicateFormat: "category = %@", predicateObjects: [selectedCategory], sortKey: "startTime", sortAscending: true) as! [TimeRecord]
